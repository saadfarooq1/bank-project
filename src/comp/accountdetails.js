    ...
    render(){
        ...
        return (
            <div>
                ...
                <Link to="/account" className="btn btn-small">Back to Account</Link>
                <div className="row">
                <div className="col s4">
                <h5>Account Details</h5>
                </div>
                <div className="col s3 offset-s5">
                <h6 to="/account" className="btn red" onClick={this.deleteAccount}>Delete Account</h6>
                </div>
                </div>
                ...
                <div className="col s4">
                <h6 className="btn green" onClick={()=>{this.getAccount("deposit")}}>Deposit</h6>
                <h6 className="btn red btn-spac" onClick={()=>{this.getAccount("withdraw")}}>withDraw</h6>
